...
import { FaXTwitter, FaTiktok, FaTwitch } from "react-icons/fa6";
...
export const platformIcons = {
  youtube: (
    <FaYoutube className="text-[#FF0000] bg-[#FF000010] size-10 p-2 rounded" />
  ),
  instagram: (
    <FaInstagram className="text-[#E1306C] bg-[#E1306C10] size-10 p-2 rounded" />
  ),
  tiktok: (
    <FaTiktok className="text-black bg-[#00000010] size-10 p-2 rounded" />
  ),
  facebook: (
    <FaFacebook className="text-[#1877F2] bg-[#1877F210] size-10 p-2 rounded" />
  ),
  twitter: (
    <FaXTwitter className="text-[#1DA1F2] bg-[#1DA1F210] size-10 p-2 rounded" />
  ),
  linkedin: (
    <FaLinkedin className="text-[#0077B5] bg-[#0077B510] size-10 p-2 rounded" />
  ),
  pinterest: (
    <FaPinterest className="text-[#E60023] bg-[#E6002310] size-10 p-2 rounded" />
  ),
  snapchat: (
    <FaSnapchat className="text-[#FFFC00] bg-[#FFFC0010] size-10 p-2 rounded" />
  ),
  twitch: (
    <FaTwitch className="text-[#9146FF] bg-[#9146FF10] size-10 p-2 rounded" />
  ),
  discord: (
    <FaDiscord className="text-[#5865F2] bg-[#5865F210] size-10 p-2 rounded" />
  ),
};
