...
const ManageListing = () => {
  ...
  const handleImageUpload = async (event) => {
    ...
    if (files.length + formData.images.length > 5)
      return toast.error("Tou can add upto 5 images");
...
try {
    if(isEditing){
        dataCopy.images = formData.images.filter((image)=>typeof image === 
        "string")
          ...
          <Section title="Basic Information">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <InputField
                ...
                placeholder="e.g. Premium Travel Account"
...
const Section = ({ title, children }) => (
  <div className=" bg-white rounded-lg border border-r-gray-200 p-6 space-y-6">
