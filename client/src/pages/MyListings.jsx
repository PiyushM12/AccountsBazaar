  ...
  return (
    <div className='px-6 md:px-16 lg:px-24 xl:px-32 pt-8'>
      ...
      <div className='grid grid-cols-1 md:grid-cols-4 gap-6 mb-8'>
        ...
        <StatCard title='Active Listings' value={activeListing} icon={<CheckCircle className='size-6 text-green-600 '  />}  color='green'/>
        <StatCard title='Sold' value={soldListing} icon={<TrendingUp className='size-6 text-indigo-600 '  />} color='indigo'/>
                      ...
                      <div className='flex items-center gap-2'>
                        <div className='relative group'>
                          ...
                          <div className='invisible group-hover:visible absolute right-0 top-0 pt-4.5 z-10'>
                            <div className='bg-white text-gray-400 text-xs rounded border border-gray-200 p-2 px-3'>
                              ...
                              <button className='text-nowrap'>
                                ...
                                <span className={
                                  ...
                                  listing.isCredentialChanged? "text-green-600":"text-indigo-600":"text-slate-600":"text-red-600" 
                                }>
                                  {listing.isCredentialSubmitted?listing.isCredentialVerified?
